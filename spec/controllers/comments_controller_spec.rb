...
RSpec.describe CommentsController, type: :controller do
  ...
  # guest users will redirect to sign in if they attempt to create or delete a comment.
  context "guest" do
  ...
  # allow member users to create new comments, but we'll redirect them to the posts show view if they try to delete another user's comment.
  ...
  # admin users are able to create and delete any comment, regardless of owner.
